...
namespace Minity.App.Exercise.ColoredTriangle
{
    public class MainScene : IScene, IDisposable
    {
        ...
        public void Setup()
        {
            ...
            var vertexShaderResource = new EmbeddedResource("src/Minity.App/Exercise002.ColoredTriangle/vert.glsl");
            var fragmentShaderResource = new EmbeddedResource("src/Minity.App/Exercise002.ColoredTriangle/frag.glsl");
