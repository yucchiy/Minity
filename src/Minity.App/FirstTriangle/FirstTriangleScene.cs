...
namespace Minity.App.FirstTriangle
{
    public class FirstTriangleScene : IScene, IDisposable
    {
        ...
        public void Setup()
        {
            ...
            var vertexShaderResource = new EmbeddedResource("src/Minity.App/FirstTriangle/vert.glsl");
            var fragmentShaderResource = new EmbeddedResource("src/Minity.App/FirstTriangle/frag.glsl");
